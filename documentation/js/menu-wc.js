...
customElements.define('compodoc-menu', class extends HTMLElement {
    ...
    render(isNormalMode) {
        ...
        <nav>
            <ul class="list">
                <li class="title">
                    <a href="index.html" data-type="index-link">app-web documentation</a>
                </li>
                ...
                <li class="chapter">
                    ...
                    <li class="chapter">
                        ...
                        <ul class="links collapse " ${ isNormalMode ? 'id="components-links"' : 'id="xs-components-links"' }>
                            ...
                            <li class="link">
                                <a href="components/ProductosComponent-1.html" data-type="entity-link" >ProductosComponent</a>
                            </li>
                            <li class="link">
                                <a href="components/UnitariasComponent.html" data-type="entity-link" >UnitariasComponent</a>
                            </li>
                        </ul>
                    </li>
                    <li class="chapter">
